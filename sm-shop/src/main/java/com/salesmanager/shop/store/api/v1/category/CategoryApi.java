...
public class CategoryApi {
	...
	@GetMapping(value = {"/category/{id:\\d+}", "/private/category/{id:\\d+}"}, produces = { APPLICATION_JSON_VALUE })
	...
	@GetMapping(value = "/category/friendly/{friendlyUrl}", produces = { APPLICATION_JSON_VALUE })
